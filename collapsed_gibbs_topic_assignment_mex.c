...
void collapsed_gibbs_topic_assignment(double *ZSDS, double *ZSWS, double *n_dot_k,
        ...
        int nrhs, const mxArray *prhs[])
{
    ...
    collapsed_gibbs_topic_assignment(ZSDS, ZSWS, n_dot_k, ZS, WS, DS, Vsize, Nsize, Ksize, WordNum, shape, eta, eta_sum, prob_cumsum);
